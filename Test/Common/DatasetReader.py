...
def ReadGraphTriple(path, folder="", index=0, hid=150, dist="deg", type=networkx.DiGraph):
    """
    ...
    :return:
    """
    path_full = path + folder + str(index) + "_full_hid" + str(hid) + "_" + dist + ".txt"
    path_part = path + folder + str(index) + "_part_hid" + str(hid) + "_" + dist + ".txt"
    path_recv = path + folder + str(index) + "_recv_hid" + str(hid) + "_" + dist + ".txt"
...
def WriteGraphTriple(path, folder, full, part, recv, hidden, distribution="deg"):
    i = 0
    while True:
        full_path = path + folder + str(i) + "_full_hid" + str(hidden) + "_" + distribution + ".txt"
        part_path = path + folder + str(i) + "_part_hid" + str(hidden) + "_" + distribution + ".txt"
        recv_path = path + folder + str(i) + "_recv_hid" + str(hidden) + "_" + distribution + ".txt"
